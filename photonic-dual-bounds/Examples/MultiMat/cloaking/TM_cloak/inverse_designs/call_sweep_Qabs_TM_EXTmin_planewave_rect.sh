#!/bin/bash
#SBATCH --job-name=cloak_Qabs_sweep_vac_gpr50_rect_1side_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j
#SBATCH --output=OUTPUT/cloak_Qabs_sweep_vac_gpr50_rect_1side_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=400
#SBATCH --error=ERRORS/cloak_Qabs_sweep_vac_gpr50_rect_1side_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j.err

module purge
module load anaconda3/2023.3
conda activate phd

prog=sweep_Qabs_TM_EXTmin_planewave.py
...
name='results/cloak_Qabs_sweep_vac_gpr50_rect_1side_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j'
