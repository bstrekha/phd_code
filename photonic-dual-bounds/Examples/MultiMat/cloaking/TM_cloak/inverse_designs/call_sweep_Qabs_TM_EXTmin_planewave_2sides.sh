#!/bin/bash
#SBATCH --job-name=cloak_Qabs_sweep_half_gpr50_circle_2sides_Rinner0d25_Router0d75_chif-4+1j_chid5+1e-3j
#SBATCH --output=OUTPUT/cloak_Qabs_sweep_half_gpr50_circle_2sides_Rinner0d25_Router0d75_chif-4+1j_chid5+1e-3j.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=14000
#SBATCH --error=ERRORS/cloak_Qabs_sweep_half_gpr50_circle_2sides_Rinner0d25_Router0d75_chif-4+1j_chid5+1e-3j.err
...
name='results/cloak_Qabs_sweep_half_gpr50_circle_2sides_Rinner0d25_Router0d75_chif-4+1j_chid5+1e-3j'
