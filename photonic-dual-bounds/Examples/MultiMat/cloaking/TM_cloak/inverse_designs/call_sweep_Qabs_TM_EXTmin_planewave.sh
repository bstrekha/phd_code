#!/bin/bash
#SBATCH --job-name=cloak_Qabs_sweep_rand_gpr50_square_Linner0d5_Louter1d5_chif4+1e-3j_chid5+1e-3j
#SBATCH --output=OUTPUT/cloak_Qabs_sweep_rand_gpr50_square_Linner0d5_Louter1d5_chif4+1e-3j_chid5+1e-3j.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=2
#SBATCH --time=32:00:00
#SBATCH --mem-per-cpu=14000
#SBATCH --error=ERRORS/cloak_Qabs_sweep_rand_gpr50_square_Linner0d5_Louter1d5_chif4+1e-3j_chid5+1e-3j.err
...
name='results/cloak_Qabs_sweep_rand_gpr50_square_Linner0d5_Louter1d5_chif4+1e-3j_chid5+1e-3j'
