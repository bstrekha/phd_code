#!/bin/bash
#SBATCH --job-name=cloak_2sides_global_Qabs_sweep_gpr35_rect_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j
#SBATCH --output=OUTPUT/cloak_2sides_global_Qabs_sweep_gpr35_rect_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=10:00:00
#SBATCH --mem-per-cpu=600
#SBATCH --error=ERRORS/cloak_2sides_global_Qabs_sweep_gpr35_rect_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j.err

module purge
module load anaconda3/2023.3
conda activate phd

prog=run_sweep_cloak_bound_2sides.py
...
name='results/cloak_2sides_global_Qabs_sweep_gpr35_rect_Lix0d5_Liy0d75_Lox1d0_Loy1d0_chif4+1e-3j_chid5+1e-3j'
