...
from Examples.MultiMat.cloaking.TM_cloak.bounds.sp_cloak_bound_gcd import sp_get_bandwidth_cloak_bound_gcd as get_bound
...
parser.add_argument('-saveint',action='store',type=int, default=1)
...
if args.sweep_type == 'Q':
    ...
    for Qabs in Qabs_list:
        print(f'Starting Qabs = {Qabs} run', flush=True)
        get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
        	...
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, init_lags=init_lags, do_checks=args.do_checks, init_global_lags=global_lags, normalize_result=normalize_result, maxiter=args.maxiter, saveint=args.saveint)
        print(f'Finished Qabs = {Qabs} run', flush=True)
        
###fix this later portion later
if args.sweep_type == 'Router':
    ...
    for Router in R_list:
        ...
        design_x = Router*2
        design_y = Router*2
        bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
            [args.des_param1, Router], args.obj, design_x, design_y, args.gpr, local_nprojx, local_nprojy, args.pml_sep, args.pml_thick, Qabs=args.Qabs, opttol=args.opttol, \
...
if args.sweep_type == 'chifRe':
    ...
    for chifRe in chifRe_list:
        ...
        bound, lags, violations, conv, nprojx, nprojy = get_bound(chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
...
if args.sweep_type == 'chifIm':
    ...
    for chifIm in chifIm_list:
        ...
        bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
            [args.des_param1, args.des_param2], args.obj, args.design_x, args.design_y, args.gpr, local_nprojx, local_nprojy, args.pml_sep, args.pml_thick, Qabs=args.Qabs, opttol=args.opttol, \
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, init_lags=init_lags, do_checks=args.do_checks, normalize_result=normalize_result)
...
if args.sweep_type == 'chidRe':
    ...
    for chidRe in chidRe_list:
        ...
        bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
            [args.des_param1, args.des_param2], args.obj, args.design_x, args.design_y, args.gpr, local_nprojx, local_nprojy, args.pml_sep, args.pml_thick, Qabs=args.Qabs, opttol=args.opttol, \
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, init_lags=init_lags, do_checks=args.do_checks, normalize_result=normalize_result)
...
if args.sweep_type == 'chidIm':
    ...
    for chidIm in chidIm_list:
        ...
        bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
            [args.des_param1, args.des_param2], args.obj, args.design_x, args.design_y, args.gpr, local_nprojx, local_nprojy, args.pml_sep, args.pml_thick, Qabs=args.Qabs, opttol=args.opttol, \
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, init_lags=init_lags, do_checks=args.do_checks, normalize_result=normalize_result)
