#!/bin/bash
#SBATCH --job-name=cloak_2sides_local3-3_Qabs_sweep_Rinner0d25_Router0d75_gpr25_chif4+1e-3j_chid5+1e-3j
#SBATCH --output=OUTPUT/cloak_2sides_local3-3_Qabs_sweep_Rinner0d25_Router0d75_gpr25_chif4+1e-3j_chid5+1e-3j.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=6:00:00
#SBATCH --mem-per-cpu=400
#SBATCH --error=ERRORS/cloak_2sides_local3-3_Qabs_sweep_Rinner0d25_Router0d75_gpr25_chif4+1e-3j_chid5+1e-3j.err
...
name='results/cloak_2sides_local3-3_Qabs_sweep_Rinner0d25_Router0d75_gpr25_chif4+1e-3j_chid5+1e-3j'
