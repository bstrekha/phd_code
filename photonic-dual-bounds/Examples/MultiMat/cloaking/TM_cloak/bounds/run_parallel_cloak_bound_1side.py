...
bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, wavelengthList, args.nmat, args.cons, args.des_region, \
        	...
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, do_checks=args.do_checks, normalize_result=args.normalize_result)
...
if args.save:
    ...
    to_save = np.array([args.obj, args.des_region, args.wavelength, args.Qabs, chif, chid, 
          ...
          args.pml_sep, args.pml_thick, args.opttol, args.fakeSratio, args.iter_period, bound], dtype=object)
    with open('results/parallel_1side_cloak_results.csv', 'ab') as f:
