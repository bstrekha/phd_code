...
def dual_debugtool(Lags, O_lin_S, O_quad, gradZTS_S, gradZTT, S_gradZSS_S, dualconst):
    ...
    ZTT_noquad = zops.get_ZTT(Lags, np.zeros(O_quad.shape), gradZTT)
    ...
    for idx, lag in enumerate(Lags):
        ...
        partial_ZTT = zops.get_ZTT(partial_lags, np.zeros(O_quad.shape), gradZTT)
        partial_S_ZSS_S = zops.get_S_ZSS_S(partial_lags, S_gradZSS_S)
