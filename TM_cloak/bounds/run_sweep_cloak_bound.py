...
if args.sweep_type == 'Q':
    ...
    if args.nprojx > 1 or args.nprojy > 1 or args.all_local_constraints == 1:
        ...
        for Qabs in Qabs_list[0:1]:
            bound, global_lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
    ...
    for Qabs in Qabs_list:
        bound, lags, violations, conv, nprojx, nprojy = get_bound(args.chifRe + 1j*args.chifIm, args.chidRe + 1j*args.chidIm, args.wavelengthList, args.nmat, args.cons, args.des_region, \
        	...
        	fakeSratio=args.fakeSratio, iter_period=args.iter_period, opttype=args.opttype, init_lags=init_lags, do_checks=args.do_checks, init_global_lags=global_lags)
