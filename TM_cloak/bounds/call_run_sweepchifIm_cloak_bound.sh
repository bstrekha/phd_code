#!/bin/bash
#SBATCH --job-name=sweepchifIm_global_gpr50_chifRe4_chid3+1e-3j_Rinner0d25_Router0d75
#SBATCH --output=OUTPUT/sweepchifIm_global_gpr50_chifRe4_chid3+1e-3j_Rinner0d25_Router0d75.txt
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=2
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=12000
#SBATCH --error=ERRORS/sweepchifIm_global_gpr50_chifRe4_chid3+1e-3j_Rinner0d25_Router0d75.err
...
name='results/sweepchifIm_global_gpr50_chifRe4_chid3+1e-3j_Rinner0d25_Router0d75'
